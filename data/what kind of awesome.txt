    ...
    def get_filter(self, scale):
        ...
        for k in range(a, b):
            ...
            if scale == 1:
                ...
                coeff_val = (-1 / 8192 )* (
                        self._dirac(k-63) + 3*self._dirac(k-62) + 6*self._dirac(k-61) + 10*self._dirac(k-60) + 15*self._dirac(k-59) +
                        ...
                        189*self._dirac(k+62) + 64*self._dirac(k+63) - 64*self._dirac(k+64) - 189*self._dirac(k+65) -
                ...
                part1 = (self._dirac(k-127) + 3*self._dirac(k-126) + 6*self._dirac(k-125) + 10*self._dirac(k-124) + 15*self._dirac(k-123) +
                        ...
                        8001*self._dirac(k-2) + 8128*self._dirac(k-1) + 8256*self._dirac(k) + 8381*self._dirac(k+1) + 8503*self._dirac(k+2) +
                ...
                part2 = (- 128*self._dirac(k+128) - 381*self._dirac(k+129) - 631*self._dirac(k+130) - 878*self._dirac(k+131) - 1122*self._dirac(k+132) -
                        ...
                        9816*self._dirac(k+240) - 9733*self._dirac(k+241) - 9647*self._dirac(k+242) - 9558*self._dirac(k+243) - 9466*self._dirac(k+244) -
